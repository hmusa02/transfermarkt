// Mock search data za lokalno testiranje
...
export function searchMockPlayers(query, limit = 5) {
  ...
  if (queryNormalized.includes('ronaldo') || queryNormalized.includes('cr7') || queryNormalized.includes('cristiano')) {
